          ...
          <div class="col-md-12">
            <div class="card card-secondary">
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                    <form  action="{{route('youtubevideo.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                          <input name="video_title" class="form-control @error('video_title') is-invalid @enderror" value="{{ old('video_title')}}"> 
                                          @error('video_title')
                                          <span class="invalid-feedback" role="alert">
                                              <small>{{ $message }}</small>
                                          </span>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                   ...
                                   <input type="text" class="form-control @error('video_link') is-invalid @enderror" name="video_link" row="3" value="{{ old('video_link')}}">
                                    @error('video_link')
                                    <span class="invalid-feedback" role="alert">
                                        <small>{{ $message }}</small>
                                    </span>
