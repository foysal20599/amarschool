          ...
          <div class="col-md-10 offset-md-1">
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Add Union </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                        ...
                        <form  action="{{route('store.union')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"  placeholder="Union name" value="{{ old('name')}}">
                                    @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <small>{{ $message }}</small>
                                    </span>
                            ...
                            <div class="card-footer">
                              <input type="submit" class="btn btn-success" value="Add Union">
                            </div>
                       </div>
                    </form>
                </div>
