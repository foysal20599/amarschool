          ...
          <div class="col-md-12">
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title" style="text-transform: uppercase;">Create Agent </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control  @error('nid_no') is-invalid @enderror" name="nid_no" value="{{ old('nid_no')}}">
                                  @error('nid_no')
                                  <span class="invalid-feedback" role="alert">
                                      <small>{{ $message }}</small>
                                  </span>
