...
@section('content')
 @include('frontEnd.include.header')
  ...
  <section class="ssitl-index3" id="about1">
    <div class="midd-ssit py-5">
  ...
  <!-- /bottom-grids-->
  <section class="ssitl-servicesblock py-5" id="about">
    <div class="container py-lg-5 py-md-3">
        <div class="row">
  ...
  <section class="ssitl-skills" id="skills">
    <div class="midd-ssit py-5">
      <div class="container py-lg-5 py-md-3">
        <div class="row">
  ...
  <!-- //home page skills section -->
  <!-- /form-25-section -->
  <section class="ssitl-form-25-section" id="subscribe">
    <!-- /form-25-section -->
  ...
  <!--/team-sec-->
  <section class="ssitl-team-main" id="team">
    <div class="team py-5">
